...
public class ZonesController : ControllerBase
{
    ...
    public async Task<IActionResult> Get(Guid zoneId, CancellationToken cancellationToken)
        => Ok(await _service.GetByIdAsync(zoneId, cancellationToken, ActorId));
    ...
    public async Task<IActionResult> Update(Guid zoneId, UpdateZoneRequest request, CancellationToken cancellationToken)
        => Ok(await _service.UpdateAsync(zoneId, request, cancellationToken, ActorId));
    ...
    public async Task<IActionResult> UpdateStatus(Guid zoneId, UpdateZoneStatusRequest request, CancellationToken cancellationToken)
        => Ok(await _service.UpdateStatusAsync(zoneId, request, cancellationToken, ActorId));

    [HttpDelete("api/zones/{zoneId:guid}")]
    public async Task<IActionResult> Delete(Guid zoneId, CancellationToken cancellationToken)
        => Ok(await _service.DeleteAsync(zoneId, cancellationToken, ActorId));
}
