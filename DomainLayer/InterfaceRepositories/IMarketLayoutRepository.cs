...
public interface IMarketLayoutRepository : IGenericRepository<MarketLayout>
{
    ...
    Task<MarketLayout> CloneToDraftAsync(Guid sourceLayoutId, string? layoutName, DateTime createdAt, CancellationToken cancellationToken = default, int? maxLayouts = null);
