...
{
    Task<ApiResponse<IReadOnlyCollection<FoodPriceResponse>>> GetFoodPricesAsync(Guid ownerId, Guid boothId, Guid foodItemId, CancellationToken cancellationToken = default);
    ...
    Task<ApiResponse<IReadOnlyCollection<PackagePriceResponse>>> GetPackagePricesAsync(Guid packageId, CancellationToken cancellationToken = default);
