...
public interface INightMarketService
{
    ...
    Task<ApiResponse<NightMarketResponse>> UpdateGeographicLocationAsync(Guid id, UpdateNightMarketGeographicLocationRequest request, CancellationToken cancellationToken = default);
