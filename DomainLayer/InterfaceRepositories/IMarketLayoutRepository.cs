...
public interface IMarketLayoutRepository : IGenericRepository<MarketLayout>
{
    ...
    Task<bool> IsEditableDraftAsync(Guid id, CancellationToken cancellationToken = default);
    ...
    Task<IReadOnlyCollection<MarketLayout>> GetPublishedMapsAsync(Guid nightMarketId, CancellationToken cancellationToken = default);
    ...
    Task<IReadOnlyCollection<LayoutBlock>> GetBlocksByLayoutIdsAsync(
        IReadOnlyCollection<Guid> layoutIds, CancellationToken cancellationToken = default);
    Task<IReadOnlyCollection<MarketLayout>> GetCompositionCandidatesByIdsAsync(
        IReadOnlyCollection<Guid> layoutIds, CancellationToken cancellationToken = default);
    ...
    Task<int> GetNextVersionAsync(Guid nightMarketId, string sectionCode, CancellationToken cancellationToken = default);
    Task<bool> ActiveNameOrVersionExistsAsync(Guid nightMarketId, string sectionCode, string name, int version, Guid? excludeId = null, CancellationToken cancellationToken = default);
    ...
    Task SetDefaultViewAsync(Guid nightMarketId, Guid layoutId, DateTime updatedAt, CancellationToken cancellationToken = default);
    Task<MarketLayout> CloneToDraftAsync(Guid sourceLayoutId, Guid targetMarketMapId, string? layoutName, DateTime createdAt, CancellationToken cancellationToken = default);
    ...
    Task<MarketLayout> SaveGraphTransactionalAsync(
        Guid layoutId,
