...
namespace InfrastructureLayer.Migrations
{
    ...
    [Migration("20260912061606_AddMapSectionsAndDefaultView")]
    partial class AddMapSectionsAndDefaultView
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DomainLayer.Entities.Complaint", b =>
                {
                    ...
                    b.Property<string>("BoothOwnerResponse")
                        .HasMaxLength(2000)
                        .HasColumnType("character varying(2000)");
            ...
            modelBuilder.Entity("DomainLayer.Entities.MarketLayout", b =>
                {
                    ...
                    b.Property<Guid?>("BasedOnLayoutId")
                        .HasColumnType("uuid");
                    ...
                    b.Property<double>("OffsetXMeters")
                        .ValueGeneratedOnAdd()
                        .HasPrecision(10, 2)
                        .HasColumnType("double precision")
                        .HasDefaultValue(0.0);

                    b.Property<double>("OffsetYMeters")
                        .ValueGeneratedOnAdd()
                        .HasPrecision(10, 2)
                        .HasColumnType("double precision")
                        .HasDefaultValue(0.0);
                    ...
                    b.HasIndex(new[] { "NightMarketId" }, "ux_marketlayout_one_default_per_market")
                        .IsUnique()
                        .HasFilter("\"IsDeleted\" = false AND \"Status\" = 'Active' AND \"IsDefaultView\" = true");

                    b.HasIndex(new[] { "NightMarketId", "SectionCode" }, "ux_marketlayout_one_published_per_section")
                        .IsUnique()
                        .HasFilter("\"IsDeleted\" = false AND \"Status\" = 'Active'");

                    b.HasIndex(new[] { "NightMarketId", "SectionCode", "Version" }, "ux_marketlayout_section_version_active")
                        .IsUnique()
                        .HasFilter("\"IsDeleted\" = false");
