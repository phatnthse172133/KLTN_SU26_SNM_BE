...
public sealed class PostgresAiV2RuntimeRecommendationTests
{
    ...
    private static async Task SeedAsync(string connectionString)
    {
        ...
        await using var command = new NpgsqlCommand(
            ...
            ('32000000-0000-0000-0000-000000000001','31000000-0000-0000-0000-000000000001','32000000-0000-0000-0000-000000000201','Open booth','16:00','23:59','Active',now(),now()),
            ('32000000-0000-0000-0000-000000000002','31000000-0000-0000-0000-000000000001','32000000-0000-0000-0000-000000000202','Closed booth','01:00','02:00','Active',now(),now()),
            ('32000000-0000-0000-0000-000000000003','31000000-0000-0000-0000-000000000001','32000000-0000-0000-0000-000000000203','Inactive booth','16:00','23:59','Inactive',now(),now()),
            ('32000000-0000-0000-0000-000000000004','31000000-0000-0000-0000-000000000002','32000000-0000-0000-0000-000000000204','Near booth','16:00','23:59','Active',now(),now()),
            ('32000000-0000-0000-0000-000000000005','31000000-0000-0000-0000-000000000003','32000000-0000-0000-0000-000000000205','Middle booth','16:00','23:59','Active',now(),now());
